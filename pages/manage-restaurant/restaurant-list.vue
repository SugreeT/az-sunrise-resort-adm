	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">All Restaurant</div>
				</div>
				<ol class="breadcrumb page-breadcrumb pull-right">
					<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
							href="index">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
					</li>
					<li><a class="parent-item" href="">Restaurant</a>&nbsp;<i class="fa fa-angle-right"></i>
					</li>
							...
							<table class="table table-hover table-checkable order-column full-width"
								...
								<tbody>
									<tr class="odd gradeX">
										...
										<td class="center">The Restaurant</td>
										<td class="left">But so that you may see from where all this error of accusing pleasure and praising pain has arisen, <br/>  I will explain the whole matter, and the very things which arise from it.</td>
										
										<td class="left">
											<span>Breakfast 7.00am – 10.00pm</span><br/>
											<span>Lunch 8.00am – 9.00am </span><br/>
											<span>Dinner 6.00pm – 7.00pm</span>
										</td>
										<td class="center">
									...
									<tr class="odd gradeX">
										...
										<td class="left" >But so that you may see from where all this error of accusing pleasure and praising pain has arisen, <br/>  I will explain the whole matter, and the very things which arise from it.</td>
										<td class="left">
											<span>Breakfast 8.00am – 10.00pm</span><br/>
											<span>Lunch 8.00am – 10.00am </span><br/>
											<span>Dinner 7.00pm – 8.00pm</span>
										</td>
										<td class="center">
